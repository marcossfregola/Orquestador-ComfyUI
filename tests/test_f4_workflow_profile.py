...
class TestH3(unittest.TestCase):
 ...
 def test_success_report_frozen(self): r=validate_ui_workflow_structure(self.w,verified_sha256='fixture'); self.assertEqual(r.sha256,'FIXTURE'); self.assertIsInstance(r.node_ids,tuple)
 ...
 def test_rewired_width(self): self.bad(lambda w:w['nodes'][5]['inputs'][16].update(link=999),IncompatibleWorkflowError)
 def test_rewired_height(self): self.bad(lambda w:w['nodes'][5]['inputs'][17].update(link=999),IncompatibleWorkflowError)
